...
<footer className="p-4 sm:p-6 dark:bg-gray-900">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <NavLink to="/" className="hover:underline">Doctor.</NavLink>. Design by Saymon Shoab.
        </span>
