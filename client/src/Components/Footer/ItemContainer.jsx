...
<footer className="p-4 sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-200 uppercase dark:text-white">Department</h2>
                <ul className="text-gray-400 dark:text-gray-400">
                    <li className="my-2">
                        <Link href="https://github.com/themesberg/flowbite" className="hover:underline ">Home</Link>
                    </li>
                    <li className="my-2">
                        <Link href="https://discord.gg/4eeurUVvTy" className="hover:underline">About</Link>
                    </li>
                    <li className="my-2">
                        <Link href="https://discord.gg/4eeurUVvTy" className="hover:underline">Service</Link>
                    </li>
                    <li className="my-2">
                        <Link href="https://discord.gg/4eeurUVvTy" className="hover:underline">Dashboard</Link>
                    </li>
                    <li className="my-2">
                        <Link href="https://discord.gg/4eeurUVvTy" className="hover:underline">Contact</Link>
                    </li>
                </ul>
            </div>
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-200 uppercase dark:text-white">Contact Us</h2>
                <ul className="text-gray-400 dark:text-gray-400">
                    <li className="mb-2">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Doctor.</a>. Design by Saymon Shoab.
        </span>
    ...
    {/* // <div classNameName='grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16'>
